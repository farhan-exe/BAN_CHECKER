...
async def check_ban_command(ctx):
    ...
    async with ctx.typing():
        ...
        if is_banned:
            embed.title = "**▌ Account Banned 🛑 **" if lang == "en" else "**▌ Compte banni 🛑 **"
            embed.description = (
            ...
            embed.title = "**▌ Account Clean ✅**" if lang == "en" else "**▌ Compte non banni ✅ **"
            embed.description = (
        ...
        embed.set_footer(text="DEVELOPED BY FARHAN EXE")
